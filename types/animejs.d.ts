...
declare namespace anime {
    ...
    function set(targets: AnimeTarget, options: object);
    function get(target: AnimeTarget, propertyName: string, unit?: string);
    function stagger(value: number | string | FunctionBasedParameter, options: object);
    // Timeline
